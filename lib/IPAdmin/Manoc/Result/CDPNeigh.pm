...
package IPAdmin::Manoc::Result::CDPNeigh;
...
__PACKAGE__->belongs_to(
    from_device => 'IPAdmin::Manoc::Result::Device',
    { 'foreign.id' => 'self.from_device' }
);

# TODO is_foreign_key_constraint doesn't work!!
#__PACKAGE__->might_have(to_device_info => 'IPAdmin::Manoc::Result::Device',
...
IPAdmin::Manoc::Result::CDPNeigh - A model object representing a CDP relationship.
